...
public class STStructures {
     ...
     * structure will have the Identifier of saomod:sky_structures.
     *
     * It is always a good idea to register your Structures so that other mods and datapacks can
     * use them too directly from the registries. It's great for mod/datapacks compatibility.
     */
    public static void registerStructureFeatures() {
        SKY_STRUCTURES = Registry.register(Registries.STRUCTURE_TYPE, new Identifier(SAOMod.MOD_ID, "sky_structures"), () -> SkyStructures.CODEC);
    }
}
